...
def wav2mfcc(file_path, n_mfcc=20, max_len=170):
    wave, sr = librosa.load(file_path, mono=True, duration=4) # removed sr=None, added: duration =4 (seconds)
...
def save_data_to_array(path=DATA_PATH, max_len=170, n_mfcc=20): #adjust max_len=170
...
def prepare_dataset(path=DATA_PATH):
    ...
    for label in labels:
        ...
        for wavfile in data[label]['path']:
            ...
            # Downsampling OPTION #do not downsample
            #wave = wave[::3]
